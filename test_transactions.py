...
class TransactionsTestCase(unittest.TestCase):
    ...
    expected_full_transaction = '010000002c00000054686520717569636b2062726f776e20666f78206a756d7073206f76657220746865206c617a7920646f672e'

    def setUp(self):
        self.byte_content = self.original_content.encode()
        logging.debug('test_newTransaction setup; content bytes: ' + self.byte_content.hex())
